...
\begin{algorithm}[H]
    ...
    \Begin{
        ...
        \ Check if is possible to aplly $trasnG$
    }%end beginre
...
Se parte de un conjunto de 200 implicaciones generadas con el algoritmo apriori a partir del dataset Mushroom incluido en el paquete arules.
