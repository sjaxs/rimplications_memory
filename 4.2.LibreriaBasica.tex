...
\subsubsection{Leer consecuente}
    ...
    Al igual que en el anterior punto, esta funci\'on ya se a usado en ejemplos anteriores, pero observemos cual es su resultado.
...
\subsubsection{Sustituir implicaci\'on}
    ...
    Tal y como se observa en el conjunto resultante, se a sustituido la anterior, por la nueva, tal y como se esperaba.
