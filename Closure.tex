...
Como se puede ver, dado un conjunto de atributos \textit{x1} y un conjunto de implicaciones \textit{mush}, en este caso de 1000 implicaciones, se puede calcular el cierre de \textit{x1} respecto a mush en tan solo 33 segundos, tiempo bastante bueno teniendo en cuenta el tama\~no del conjunto de implicaciones. \\ 
\begin{figure}[h]
    \centering
