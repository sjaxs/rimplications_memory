\section{Creaci\'on y distribuci\'on de un paquete R en CRAN}
...
Para m\'as informaci\'on a cerca de los paquetes de R ver \cite{rcore} y \cite{book}, de donde se ha obtenido al mayor parte de la informaci\'on necesaria para este estudio.
...
los cu\'ales se van a detallar a continuaci\'on\cite{rParaTodos}.
...
detallada del uso de la funci\'on. Tambi\'en se puede usar el tag \textbf{@section}
...
\begin{itemize}
    ...
    \item \textbf{Note}: Problema leve que se deber\'ia arreglar en caso de querer subir el paquete a CRAN incluso si se trata de un falso positivo.
\end{itemize}
...
Una vez que el paquete ya est\'a listo para subirlo, se deben  tener en cuenta dos archivos importantes m\'as,\textbf{ README.md}, el cual proporciona una descripci\'on del paquete, su
